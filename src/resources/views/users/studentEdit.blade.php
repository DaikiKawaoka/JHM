...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('生徒アカウント編集') }}</div>
                    <div class="card-body">
                        ...
                        <div class="tab-content mt-4" id="myTabContent">
                            ...
                            @error('password')@elseerror('password_current')@else show active @enderror" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <form action="{{route('users.updateStudentProfile', $user->id)}}" method="post">
                                    @csrf
                                    {{ method_field('PUT') }}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="attend_num" type="number" class="form-control @error('attend_num') is-invalid @enderror" name="attend_num" value="{{ old('attend_num') ?? $user->attend_num }}" required autocomplete="attend_num" min="1" max="50" autofocus>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') ?? $user->name }}"  autofocus require>
                                        </div>
                                        @error('name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group row">
                                        <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('生徒メールアドレス') }}</label>
